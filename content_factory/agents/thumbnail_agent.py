...
class ThumbnailAgent:
    def create_thumbnail(self, verdict: LitVerdict, output_path: Path) -> Path:
        ...
        draw.text((70, 120), "GHOST TOWN\nTEST", fill=(255, 255, 255), font=title_font, spacing=10)
        y = 470
        ...
        draw.text((110, 1080), f"SCORE: {verdict.lit_score}/100", fill=(15, 23, 42), font=body_font)
        draw.text((110, 1180), verdict.verdict_headline.upper()[:24], fill=(15, 23, 42), font=small_font)
        draw.text((70, 1680), "Would you build it?", fill=(255, 255, 255), font=small_font)
