        ...
        try:
            rendered = render_template(
                template,
                {
                    ...
                    "ghost_town_risk": verdict.ghost_town_risk,
                    "buyer_pain_clarity": verdict.buyer_pain_clarity,
                    "willingness_to_pay_signal": verdict.willingness_to_pay_signal,
                    "distribution_difficulty": verdict.distribution_difficulty,
                    "unfair_advantage_check": verdict.unfair_advantage_check,
                    "business_model_weakness": verdict.business_model_weakness,
                    "why_it_might_work": verdict.why_it_might_work,
                    "why_it_might_fail": verdict.why_it_might_fail,
                    "killer_question": verdict.killer_question,
                    "mvp_test": verdict.mvp_test,
                    "locale": locale,
                    "cta": legacy.cta,
                },
            )
