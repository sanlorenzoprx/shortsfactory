...
class OnlineLLMCreativeGenerationProvider(CreativeGenerationProvider):
    ...
    def _compact_prompt(context: CreativeGenerationContext) -> str:
        ...
        return (
            ...
            "Angle intent:\n"
            "- ghost_town_risk: expose the risk of building for a market that may not care\n"
            "- buyer_reality: confront whether real buyers would act, pay, reply, book, or switch\n"
            "- fast_validation_test: give a fast test before building more\n"
            "- contrarian_opportunity: show the narrow opportunity hidden inside a weak or risky idea\n"
            "- builder_action_plan: give the next concrete builder move\n"
